...
//        if (!isset($this->ar_set["created"]) || !isset($this->ar_set["modified"])) {
//            $now = date("Y-m-d H:i:s");
//            if (!isset($this->ar_set["created"])) {
//                $this->ar_set["created"] = "'" . $now . "'";
//            }
//            if (!isset($this->ar_set["modified"])) {
//                $this->ar_set["modified"] = "'" . $now . "'";
//            }
//        }
...
//        if (!isset($this->ar_set["modified"])) {
//            $this->ar_set["modified"] = "'" . date("Y-m-d H:i:s") . "'";
//        }
